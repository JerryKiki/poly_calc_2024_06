...
public class Tests {
    ...
    @Test
    @DisplayName("(8 + 2) + (7 + 3) + 5 == 25")
    void t32() {
        assertThat(Calc.run("(8 + 2) + (7 + 3) + 5")).isEqualTo(25);
    }

    @Test
    @DisplayName("(8 + 2) + 5 + (7 + 3) + 5 == 30")
    void t33() {
        assertThat(Calc.run("(8 + 2) + 5 + (7 + 3) + 5")).isEqualTo(30);
    }

    @Test
    @DisplayName("(8 + 2) * 5 + (7 + 3) * 5 == 100")
    void t34() {
        assertThat(Calc.run("(8 + 2) * 5 + (7 + 3) * 5")).isEqualTo(100);
    }

    @Test
    @DisplayName("(8 + 2) * (5 - 3) + (7 + 3) == 30")
    void t35() {
        assertThat(Calc.run("(8 + 2) * (5 - 3) + (7 + 3)")).isEqualTo(30);
    }
}